...
describe("stake test", async function () {
    ...
    it("deploy", async function () {
        ...
        stakeProxyContract = await upgradesApi.deployProxy(metaNodeStake.connect(admin), [erc20ddress, blockNumber, blockNumber + blockHight, metaNodePerBlock], { kind: "uups" })
